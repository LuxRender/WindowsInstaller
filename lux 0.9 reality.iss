...
#define MyAppVerName "LuxRender pre-0.9 for Reality"
...
#define MyLuxFileRoot StringChange("LuxRender " + StringChange(StringChange(MyAppArch, "x86", "32"), "x64", "64") + " " + MyAppCLArch, " ", "_")  
...
Name: main; Description: LuxRender; Flags: fixed; Types: default custom; Languages:
;Name: examplescene; Description: Example Scenes; Types: default full; Languages: 
Name: examplescene; Description: Example Scenes; Types: default; Languages: 
...
begin
  ...
  ver := '2.57'; // assume first official
	for i:= 0 to rootCount-1 do
	begin
	  if RegQueryStringValue(regRoot[i], 'SOFTWARE\BlenderFoundation',
	...
	begin
		if RegQueryStringValue(regRoot[i], 'SOFTWARE\BlenderFoundation',
				'ConfigData_Dir', result) then
		begin
			result:= AddBackslash(result) + ver + '\scripts';
